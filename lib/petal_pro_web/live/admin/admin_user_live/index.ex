      ...
      >
        ...
        <%= if @user.is_suspended do %>
          <.dropdown_menu_item
            ...
            data-confirm={gettext("Are you sure?")}
          >
            <.icon name="hero-arrow-uturn-down" class="h-5 w-5" />
        ...
        <%= if PetalPro.Accounts.Permissions.can_impersonate?(@user, @current_user) do %>
          <.dropdown_menu_item link_type="a" to={~p"/auth/impersonate?id=#{@user.id}"} method="post">
            <.icon name="hero-user" class="h-5 w-5" /> {gettext("Impersonate")}
          </.dropdown_menu_item>
        <% end %>
        ...
        <%= if @user.is_deleted do %>
          <.dropdown_menu_item
            ...
            data-confirm={gettext("Are you sure?")}
          >
            <.icon name="hero-check" class="h-5 w-5" /> {gettext("Undo delete")}
          </.dropdown_menu_item>
        <% else %>
          <.dropdown_menu_item
            phx-click={
