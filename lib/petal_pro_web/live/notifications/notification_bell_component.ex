defmodule PetalProWeb.NotificationBellComponent do
  ...
  attr :dropdown_class, :string,
    default:
      "hidden absolute sm:right-0 -right-14 z-10 p-4 mt-2 origin-top-right border border-gray-200 dark:border-gray-700 bg-white dark:dark:bg-gray-800 dark:text-gray-100 rounded-md shadow-lg",
  ...
  def render(assigns) do
    ...
    <div id={@id} phx-hook="NotificationBellHook" class="relative">
      ...
      >
        ...
        <span
          :if={@unread_count > 0}
          class="absolute top-2 right-2.5 h-2 w-2 rounded-full bg-red-500"
        />
        ...
        <div class="flex flex-col space-y-2">
          <div class="flex">
            ...
            <.button
              color="light"
              size="xs"
              class="my-auto h-7 whitespace-nowrap"
  ...
  defp notifications_list(assigns) do
    ~H"""
    <div class="max-h-[500px] flex flex-col space-y-1 overflow-y-auto pt-4">
      <.notification_item
    ...
    <div class="my-auto mt-1 flex select-none border-t border-gray-200 pt-4 dark:border-gray-700">
