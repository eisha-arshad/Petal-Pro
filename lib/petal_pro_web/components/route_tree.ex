defmodule PetalProWeb.RouteTree do
  ...
  def route_tree(assigns) do
    ...
    ~H"""
    <div class="ml-[60px] flex flex-col gap-1">
      <%= for key <- @sections do %>
  ...
  def route(assigns) do
    ...
    >
      ...
      >
        <div class="left-[-60px] w-[46px] absolute flex justify-end">
        ...
        <div class="flex gap-3 text-sm text-gray-500 dark:text-gray-400">
          ...
          <div class="after-copied hidden text-green-600 dark:text-green-300">Copied!</div>
        </div>
      </div>
    </div>
    """
