    ...
    <%= case @type do %>
      <% "sidebar" -> %>
        <.sidebar_layout {assigns}>
          <:logo>
            <.logo class="h-8 transform transition-transform duration-300 ease-out hover:scale-105" />
          </:logo>
          <:logo_icon>
            <.logo_icon />
          </:logo_icon>
      ...
      <% "stacked" -> %>
        <.stacked_layout {assigns}>
          <:logo>
            <div class="flex h-full w-24 shrink-0 items-center">
              <div class="hidden lg:block">
                <.logo class="h-8" />
              </div>
              <div class="block lg:hidden">
                <.logo_icon class="h-8 w-auto" />
              </div>
            </div>
          </:logo>
          <:top_right>
