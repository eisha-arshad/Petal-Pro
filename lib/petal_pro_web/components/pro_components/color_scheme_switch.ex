defmodule PetalProWeb.ColorSchemeSwitch do
  ...
  def color_scheme_switch(assigns) do
    ...
    <button
      ...
      class={[
        "color-scheme rounded-lg p-2.5 text-sm text-gray-500 hover:bg-gray-100 focus:outline-hidden focus:ring-4 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-700",
        @class
      ]}
    >
      <svg
        class="color-scheme-dark-icon hidden h-5 w-5"
        fill="currentColor"
        viewBox="0 0 20 20"
      ...
      <svg
        class="color-scheme-light-icon hidden h-5 w-5"
        fill="currentColor"
        viewBox="0 0 20 20"
        xmlns="http://www.w3.org/2000/svg"
      >
