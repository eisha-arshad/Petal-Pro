defmodule PetalProWeb.SocialButton do
  ...
  def social_button(assigns) do
    ...
    <.a
      ...
      to={@to}
      class={[
        "inline-flex items-center justify-center gap-4 rounded-md border px-4 py-2 text-sm font-medium leading-5",
        get_social_button_classes(%{logo: @logo, variant: @variant}),
        @class
      ]}
    >
      <%= if @logo == "google" do %>
        <svg class="h-5 w-5" viewBox="0 0 19 20" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path
      ...
      <%= if @logo == "github" do %>
        <svg
          class={"#{if @variant == "solid", do: "fill-white", else: "fill-gray-800 dark:fill-white"} h-5 w-5"}
          viewBox="0 0 21 20"
          fill="none"
      ...
      <%= if @logo == "facebook" do %>
        <svg
          class={"#{if @variant == "solid", do: "fill-white", else: "fill-[#1778F2]"} h-5 w-5"}
          fill="none"
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 320 512"
        >
      ...
      <%= if @logo == "twitter" do %>
        <svg
          class={"#{if @variant == "solid", do: "fill-white", else: "fill-[#1da1f2]"} h-5 w-5"}
          fill="none"
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 512 512"
        >
      ...
      <%= if @logo == "apple" do %>
        <svg
          class={"#{if @variant == "solid", do: "fill-white", else: "fill-[#050708] dark:fill-white"} h-5 w-5"}
          fill="none"
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 384 512"
        >
      ...
      <%= if @logo == "linkedin" do %>
        <svg
          class={"#{if @variant == "solid", do: "fill-white", else: "fill-[#0B65C2]"} h-5 w-5"}
          fill="none"
          xmlns="http://www.w3.org/2000/svg"
