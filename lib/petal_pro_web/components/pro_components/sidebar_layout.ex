defmodule PetalProWeb.SidebarLayout do
  ...
  def sidebar_layout(assigns) do
    ...
    >
      <div
        class={["relative z-40 transition-transform"]}
      ...
      >
        ...
        <div
          ...
          class="bg-gray-900/80 fixed inset-0"
        >
        </div>
        ...
        <button
          ...
          class="-right-[12px] top-[51px] w-[25px] h-[25px] absolute z-40 hidden items-center justify-center rounded-md border border-gray-200 bg-white text-gray-700 transition-colors hover:bg-gray-50 hover:text-gray-900 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-100 dark:hover:bg-gray-900 dark:hover:text-gray-50 lg:flex"
        ...
        >
          ...
          <div class="-space-x-[4px] m-1 flex flex-row">
            <.icon name="hero-chevron-left-solid" class="h-3 w-3 fill-current" />
            <.icon name="hero-chevron-right-solid" class="h-3 w-3 fill-current" />
          </div>
        </button>
        ...
        <div
          id="sidebar"
          class={[
            "no-scrollbar absolute top-0 left-0 z-40 h-screen shrink-0 transform overflow-y-auto border-r p-4 transition-transform duration-200 ease-in-out lg:static lg:top-auto lg:left-auto lg:translate-x-0 lg:overflow-y-auto",
            @sidebar_bg_class,
      ...
      <div class="relative flex flex-1 flex-col overflow-x-auto overflow-y-auto pb-12 lg:pb-0">
        <header class={[
          "sticky top-0 z-30 border-b backdrop-blur-sm dark:border-b lg:backdrop-filter lg:dark:shadow-none",
          @header_bg_class,
          @header_border_class
        ]}>
          <div class="px-4 sm:px-6 lg:px-8">
            <div class="-mb-px flex h-16 items-center justify-between">
              <div class="min-w-[68px] flex">
                <button
